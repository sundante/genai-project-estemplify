...
export function RisksTab() {
  const { resetRisks } = useWorkspaceStore()
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-lg font-bold text-slate-800 dark:text-white">Risks</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">RAID register and mitigation tracking.</p>
        </div>
        <SectionActions section="risks" onReset={resetRisks} />
      </div>
