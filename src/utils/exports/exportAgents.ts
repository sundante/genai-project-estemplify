...
export const exportAsExcel = (state: WorkbenchState) => exportSectionAsExcel('agents', state);
export const exportAsPdf = (state: WorkbenchState) => exportSectionAsPdf('agents', state);
export const exportAsWord = (state: WorkbenchState) => exportSectionAsWord('agents', state);
